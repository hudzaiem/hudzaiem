...
// function change(){
        ...
        echo "\n".color("yellow","!] Total voucher Lu ".$total." : ");
	...
	$post = [
 		'chat_id' => $chatid,
            ...
            echo color("red","-] Otp yang lu masukin salah");
            echo"\n==================================\n\n";
            echo color("yellow","!] Silahkan ketik yg bener\n");
            goto otp;
            }
         }else{
         echo color("red","-] Nomor ini udh digunakan cok");
         echo"\n==================================\n\n";
         echo color("yellow","!] Lu harus registrasi kembali\n");
         goto ulang;
         }
//  }
// echo change()."\n";
